...
PROJET_APPS = ['apps.user', 'apps.movie', 'apps.review']

INSTALLED_APPS = DJANGO_APPS + THIRD_PARTY_APPS + PROJET_APPS
...
CORS_ORIGIN_WHITELIST = [
    ...
    'http://127.0.0.1:8000',
    'http://127.0.0.1:3000',
    'http://scalar.giovaborgogno.com',
    'https://scalar.giovaborgogno.com',
    'http://frontend:3000',
]
...
if not DEBUG:
    DEFAULT_FROM_EMAIL = 'Giovanni - Software Developer <testing@itvirtuous.com>'
