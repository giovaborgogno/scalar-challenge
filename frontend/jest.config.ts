...
const config: Config = {
  ...
  // cacheDirectory: "/private/var/folders/ls/7681f3912913hkrpkgrtzyz40000gn/T/jest_dx",
  ...
  collectCoverageFrom: [
    "src/**/*.{js,jsx,ts,tsx}", // Incluye todos los archivos .js y .jsx en el directorio actual
